...
source("BGD_2020_Markets_Covid/scripts/functions/get_na_response_rates.R")
...
# date_log_old <-read.csv("outputs/01_data_logger/date_log.csv", 
                        # stringsAsFactors = FALSE,na.strings = c("", " ", NA)) %>% select("X_uuid","round")

# main <- main %>% dplyr::left_join(date_log_old,by = "X_uuid")
